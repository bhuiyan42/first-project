...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 		 
    $title  = mysqli_real_escape_string($db->link, trim($_POST['title']));
    $cat    = mysqli_real_escape_string($db->link, trim($_POST['cat']));
    $body    = mysqli_real_escape_string($db->link, trim($_POST['body']));
    $tags   = mysqli_real_escape_string($db->link, trim($_POST['tags']));
    $author = mysqli_real_escape_string($db->link, trim($_POST['author']));
    $userid = mysqli_real_escape_string($db->link, trim($_POST['userid']));
